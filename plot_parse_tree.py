...
parse_tree_output_file = open("./parse_tree_small_output")
...
fig.tight_layout()
nx.draw(T, pos, with_labels=True,labels=names_dict, font_size=9.2, node_size=0, node_shape='s', bbox=dict(facecolor="skyblue", edgecolor='black', boxstyle='round,pad=0.3'))
plt.savefig("./parse_tree_smallest_t9.png",bbox_inches='tight')
