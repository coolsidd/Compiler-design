...
Symbol toSymbol(char *enustr) {
    ...
    if (strcmp(enustr, "jagged_array_declaration") == 0) {
        ans->is_terminal = false;
        ans->s = jagged_array_declaration;
        return *ans;
    }
...
char* getSymbol(Symbol symb) {
    ...
    case (jagged_array):
        return "jagged_array";
    case (jagged_array_declaration):
        return "jagged_array_declaration";
